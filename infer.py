...
class Material_Project_Dataset(torch.utils.data.Dataset):
    def __init__(self, mode, construct_kernel, device, dataset_root='/home/zjdai/software/large_scale_inference/Debug/NextHAM_V1_1_Inference/datasets/'):
        super().__init__()
        self.mode = mode
...
def main(args):
    ...
    for model_idx in range(4):
        models.append(torch.load(checkpoint_paths[model_idx]).to(device))
        print('loaded model '+str(model_idx))
